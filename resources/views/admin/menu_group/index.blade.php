                    ...
                    <table class="table border">
                        ...
                        <tr>
                            ...
                            <th scope="col">
                                ...
                                {!! $dbSort::viewIcons('title', $info['view'], $info['slug']) !!}
                            </th>
                            <th scope="col">
                                <span>@lang('a.sort')</span>
                                {!! $dbSort::viewIcons('sort', $info['view'], $info['slug']) !!}
                            </th>
                            <th scope="col">
                                <span>@lang('a.id')</span>
                        ...
                        @foreach($values as $item)
                            <tr>
                                <th scope="row" class="d-flex">
                                    <a href="{{ route("admin.{$info['slug']}.edit", $item->id) }}" class="btn btn-info btn-sm mr-1 pulse" title="@lang('a.edit')">
